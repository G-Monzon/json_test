...
from get_summary_info import summary_from_string, summary_from_file, get_summary
...
def main():
    ...
    json_convertido = summary_from_string(ejemplo_json_string)
    summary = get_summary(json_convertido)

    lista_emitidas = get_sent_invoices_xml(json_convertido)
    listas_recibidas = get_received_invoices_xml(json_convertido)

    for emitida in lista_emitidas:
        # print(emitida)
        emitida_decodificada = decode64(emitida)

    for recibida in listas_recibidas:
        # print(recibida)
        recibida_decodificada = decode64(recibida)
